    ...
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //    //...
        //});
        builder.Entity<IdentityUser>().HasQueryFilter(u => !u.IsDeleted);
        builder.Entity<Reservation>().HasQueryFilter(i => !i.User.IsDeleted);
        builder.Entity<Reservation>().HasKey(pm => new { pm.BookId, pm.UserId });
